...
public final class ASimpleExpressionExpression extends PExpression
{
    private PSimpleExpression _simpleExpression_;

    public ASimpleExpressionExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASimpleExpressionExpression(
    ...
    {
        ((Analysis) sw).caseASimpleExpressionExpression(this);
    }
