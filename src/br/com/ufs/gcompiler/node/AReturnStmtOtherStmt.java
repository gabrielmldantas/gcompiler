...
public final class AReturnStmtOtherStmt extends POtherStmt
{
    private PReturnStmt _returnStmt_;

    public AReturnStmtOtherStmt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AReturnStmtOtherStmt(
    ...
    {
        ((Analysis) sw).caseAReturnStmtOtherStmt(this);
    }
